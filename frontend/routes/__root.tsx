...
const THEME_INIT = `try{var t=localStorage.getItem('seatsync-theme')||'light';if(t==='dark'){document.documentElement.classList.add('dark');document.documentElement.style.colorScheme='dark';}}catch(e){}`;
